        ...
        else if (keyboard_check_pressed(global.input_k[4]) || keyboard_check_pressed(vk_enter) || gamepad_button_check_pressed(obj_gamecontroller.gamepad_id, global.input_g[4]))
        {
            ...
            else
            {
                ...
                else if (choice == "[warp]")
                {
                    ...
                    if (choice_data > 0 && choice_data < 32) || (choice_data > 92 && choice_data < 109)
                        global.darkzone = 0
                    else
                        global.darkzone = 1
                    ...
                    {
                        global.flag[916] = 0 // weird route aborted
                        global.flag[915] = 20 // ch2 weird route progress
                    ...
                    switch choice_data
                    {
                        ...
                        case 19: // kris on the phone in the kitchen
                            ...
                            if (!i_ex(obj_homealone_vent_loader))
                            {
                                ...
                                loader.load_room = room_lw_noellehouse_kitchen
                                loader.load_vent = "A"
                            }
                        ...
                        case 21: // asgore in the bathroom
                            ...
                            {
                                var loader = instance_create(0, 0, obj_homealone_vent_loader)
                                loader.load_room = room_lw_noellehouse_bathroom
                                loader.load_vent = "toilet"
                            }
                        ...
                        case 22: // asgore in carol and rudy's room
                            ...
                            {
                                var loader = instance_create(0, 0, obj_homealone_vent_loader)
                                loader.load_room = room_lw_noellehouse_north
                                loader.load_vent = "north"
                            }
                        ...
                        case 23: // noelle's basement
                            ...
                            {
                                var loader = instance_create(0, 0, obj_homealone_vent_loader)
                                loader.load_room = room_lw_noellehouse_basement
                        ...
                        case 25: // dess's room as the soul
                            ...
                            {
                                var loader = instance_create(0, 0, obj_homealone_vent_loader)
                                loader.load_room = room_lw_noellehouse_dess
