...
if (global.interact == 0 && freeze == 0)
{
	...
	if (room == room_town_north && global.plot >= 190 && global.plot < 200)
		run = 0
	if (autorun > 0)
	{
		if (autorun == 1)
...
if (battlemode == 1)
{
	...
	if (global.inv < 0)
	{
		...
		with (collision_line(x + 26, y + 49, x + 19, y + 57, obj_overworldbulletparent, 1, 0))
			event_user(5)
		with (collision_rectangle(x + 12, y + 40, x + 27, y + 49, obj_overworld_foxbullet, 1, 0))
			event_user(5)
		with (collision_line(x + 12, y + 49, x + 19, y + 57, obj_overworld_foxbullet, 1, 0))
			event_user(5)
		with (collision_line(x + 26, y + 49, x + 19, y + 57, obj_overworld_foxbullet, 1, 0))
			event_user(5)
	}
}
...
/*if (scr_debug())
{
	...
	if (sunkus_kb_check_pressed(vk_home) && floorheight == 0)
	{
