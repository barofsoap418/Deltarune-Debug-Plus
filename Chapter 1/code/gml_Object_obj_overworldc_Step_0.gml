		...
		if (global.menuno == 5)
		{
			...
			if (global.menucoord[5] == 2)
			{
				...
				if (dontthrow == 0)
				{
					i = round(random(30))
					if (i == 0)
						global.msg[0] = scr_84_get_lang_string("obj_overworldc_slash_Step_0_gml_32_0") + global.litemname[global.menucoord[1]] + "." // * You bid a quiet farewell to the 
					if (i == 1)
						global.msg[0] = scr_84_get_subst_string(scr_84_get_lang_string("obj_overworldc_slash_Step_0_gml_33_0"), global.litemname[global.menucoord[1]]) // * You put the ~1 on the ground and gave it a little pat.
					if (i == 2)
						global.msg[0] = scr_84_get_subst_string(scr_84_get_lang_string("obj_overworldc_slash_Step_0_gml_35_0"), global.litemname[global.menucoord[1]]) // * You threw the ~1 on the ground like the piece of trash it is.
					if (i == 3)
						global.msg[0] = scr_84_get_lang_string("obj_overworldc_slash_Step_0_gml_36_0") + global.litemname[global.menucoord[1]] + "." // * You abandoned the 
					if (i > 3)
						global.msg[0] = scr_84_get_subst_string(scr_84_get_lang_string("obj_overworldc_slash_Step_0_gml_37_0"), global.litemname[global.menucoord[1]]) // * The ~1 was thrown away.
					global.msg[0] += scr_84_get_lang_string("obj_overworldc_slash_Step_0_gml_38_0") // /%
					if (global.litem[global.menucoord[1]] == 8)
					{
						global.msg[0] = scr_84_get_lang_string("obj_overworldc_slash_Step_0_gml_41_0") // * What Egg?/%
				...
				if (dontthrow == 1)
				{
					...
					{
						global.msg[0] = scr_84_get_lang_string("obj_overworldc_slash_Step_0_gml_42_0") // * (You didn't quite understand why...)/
						global.msg[1] = scr_84_get_lang_string("obj_overworldc_slash_Step_0_gml_43_0") // * (But, the thought of discarding it felt very wrong.)/%
						script_execute(scr_writetext, 0, "x", 0, 0)
					}
				}
			}
