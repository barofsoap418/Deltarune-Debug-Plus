...
if (scr_debug())
{
    // set to specifically rshift to try and prevent it from conflicting too much with the shift+F chack in obj_debugProfiler
    if (keyboard_check(vk_rshift) && keyboard_check_pressed(ord("F")))
    {
        scr_weaponget(13)
        snd_play(snd_ominous)
    }
